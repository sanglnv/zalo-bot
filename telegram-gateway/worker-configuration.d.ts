/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2b40ffd894387f9eff865f8e30506b0a)
// Runtime types generated with workerd@1.20260708.1 2026-07-14 nodejs_compat
interface __BaseEnv_Env {
	CATALOG_DB: D1Database;
	TELEGRAM_UPDATES: Queue;
	TELEGRAM_DLQ: Queue;
	FAST_PATH_SYNC: Queue;
	...
	GAS_GATEWAY_TOKEN: string;
	GAS_ADMIN_API_TOKEN: string;
	TELEGRAM_OPERATIONS_CHAT_ID: string;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "TelegramSession";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_WEBHOOK_URL" | "FAST_PATH_ENABLED" | "PAYMENT_TIMEOUT_MINUTES" | "TELEGRAM_WEBHOOK_SECRET" | "TELEGRAM_BOT_TOKEN" | "GAS_WEB_APP_URL" | "GAS_GATEWAY_TOKEN" | "GAS_ADMIN_API_TOKEN" | "TELEGRAM_OPERATIONS_CHAT_ID" | "TELEGRAM_ADMIN_USER_IDS" | "VIETQR_BANK_ID" | "VIETQR_ACCOUNT_NO" | "VIETQR_ACCOUNT_NAME">> {}
}
