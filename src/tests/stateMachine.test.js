...
const valid = {
  ...
  BROWSING: { START_BROWSING: 'BROWSING', ADD_TO_CART: 'CART', CANCEL: 'CANCELLED' },
  CART: { ADD_TO_CART: 'CART', UPDATE_CART: 'CART', REVIEW_CART: 'CONFIRMING', CANCEL: 'CANCELLED' },
  CONFIRMING: {
  ...
  PAID: { COMPLETE: 'DONE', START_NEW_ORDER: 'BROWSING' },
  DONE: { START_NEW_ORDER: 'BROWSING' },
  CANCELLED: { START_NEW_ORDER: 'BROWSING' },
  EXPIRED: { START_NEW_ORDER: 'BROWSING' }
};
